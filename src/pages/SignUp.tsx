  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      <div className="lg:hidden fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1512820790803-83ca734da794?w=1200&q=80')] bg-cover bg-center opacity-20" />
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
            ...
            >
              ...
              <p className="text-[var(--text-muted)] text-lg leading-relaxed">
                Join a world of stories waiting to be discovered. Create your account and start your reading journey today.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 h-screen overflow-y-auto flex items-start justify-center py-8 px-6 sm:px-12">
          ...
          >
            ...
            <p className="mt-6 text-center text-[var(--text-muted)] text-sm">
              ...
              <Link to="/signin" className="text-[var(--gold)] hover:text-[var(--gold-deep)] font-medium transition-colors">
                Sign in
              </Link>
            </p>
